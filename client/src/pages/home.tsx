...
import { Monitor, Server, Printer, Tv, Search, Star, ShoppingCart, User, Truck, CreditCard, Check, Bolt, HelpCircle, ShoppingBag, Lightbulb, Package, Wrench, HeadphonesIcon } from "lucide-react";
import type { Product, Service, CartItem, Order } from "@shared/schema";
            ...
            {featuredProducts.length > 0 ? (
              featuredProducts.map((product: Product) => (
                <ProductCard key={product.id} product={{
                  ...
                  isHot: product.isHot || undefined,
                  isNew: product.isNew || undefined,
                  inStock: product.inStock || undefined
                }} />
              ))
            ) : (
              // Produits d'exemple quand la base est vide
              [{
                id: "demo-1",
            ...
            {featuredServices.length > 0 ? (
              featuredServices.map((service: Service) => (
                <ServiceCard key={service.id} service={{
                  ...
                  isNew: service.isNew || undefined
                }} />
              ))
            ) : (
              // Services d'exemple quand la base est vide
              [{
                id: "demo-s1",
